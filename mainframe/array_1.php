...
$source1 = "$base_url/hour2_$today.html";
    ...
    if ($html) {
        ...
        foreach($html->find('tr') as $row) {
            ...
            //echo $row->plaintext . '<br>';
            //}
          mysql_query("UPDATE `apireading` SET `6am`='$time6',`7am`='$time7',`8am`='$time8',`9am`='$time9',`10am`='$time10',`11am`='$time11' WHERE `area`='$area';");
        }
        }
    }
////////////////////  array 3 //////////////////////////////////////////
$source2= "$base_url/hour3_$today.html";
    ...
    if ($html) {
        ...
        foreach($html->find('tr') as $row) {
            ...
            //echo $row->plaintext . '<br>';
            //}
          mysql_query("UPDATE `apireading` SET `12pm`='$time12',`1pm`='$time13',`2pm`='$time14',`3pm`='$time15',`4pm`='$time16',`5pm`='$time17' WHERE `area`='$area';");
        }
        }
    }
////////////////// array 4 /////////////////////////////////
