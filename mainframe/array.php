...
//run/execute mysql query
            mysql_query("INSERT IGNORE INTO `apireading`(`id`, `state`, `area`, `12am`, `1am`, `2am`, `3am`, `4am`, `5am`, `6am`, `7am`, `8am`, `9am`, `10am`, `11am`, `12pm`, `1pm`, `2pm`, `3pm`, `4pm`, `5pm`, `6pm`, `7pm`, `8pm`, `9pm`, `10pm`, `11pm`) VALUES ('','$state','$area','','','','','','','','','','','','','','','','','','','','','','','','')") or die (mysql_error());
            }
          //  if (!$insertquery) {
            //die('Invalid query: ' . mysql_error());
        mysql_query("UPDATE `apireading` SET `12am`='$time',`1am`='$time1',`2am`='$time2',`3am`='$time3',`4am`='$time4',`5am`='$time5' WHERE `area`='$area';");
           //}
          //  mysql_close($conn);
            //echo($state);
...
$source1 = "$base_url/hour2_$today.html";
    ...
    if ($html) {
        ...
        foreach($html->find('tr') as $row) {
            ...
            //echo $row->plaintext . '<br>';
            //}
          mysql_query("UPDATE `apireading` SET `6am`='$time6',`7am`='$time7',`8am`='$time8',`9am`='$time9',`10am`='$time10',`11am`='$time11' WHERE `area`='$area';") or die (mysql_error());
        }
        }
    }
////////////////////  array 3 //////////////////////////////////////////
$source2= "$base_url/hour3_$today.html";
    ...
    if ($html) {
        ...
        foreach($html->find('tr') as $row) {
            ...
            //echo $row->plaintext . '<br>';
            //}
          mysql_query("UPDATE `apireading` SET `12pm`='$time12',`1pm`='$time13',`2pm`='$time14',`3pm`='$time15',`4pm`='$time16',`5pm`='$time17' WHERE `area`='$area';") or die (mysql_error());
        }
        }
    }
////////////////// array 4 /////////////////////////////////
$source3 = "$base_url/hour4_$today.html";
    ...
    if ($html) {
        ...
        foreach($html->find('tr') as $row) {
            ...
            //echo $row->plaintext . '<br>';
            //}
          mysql_query("UPDATE `apireading` SET `6pm`='$time18',`7pm`='$time19',`8pm`='$time20',`9pm`='$time21',`10pm`='$time22',`11pm`='$time23' WHERE `area`='$area';") or die (mysql_error());
